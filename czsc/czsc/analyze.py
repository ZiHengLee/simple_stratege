...
class CZSC:
    ...
    def update(self, bar: RawBar):
        ...
        for bar in last_bars:
            if len(bars_ubi) < 2:
                newBar = NewBar(symbol=bar.symbol, id=bar.id, freq=bar.freq, dt=bar.dt,
    ...
    def bi_calculate(self):
        ...
        for bi in bis:
            ...
            fxs_a = fxs[0]
            fxs_b = fxs[len(fxs)-1]
            bi.vol = vols - fxs_a.elements[0].vol - fxs_b.elements[2].vol
